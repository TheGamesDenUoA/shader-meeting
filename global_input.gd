...
func _input(event: InputEvent) -> void:
	if event.is_action_pressed("enable_mouse_capture") and Input.mouse_mode != Input.MOUSE_MODE_CAPTURED:
		Input.mouse_mode = Input.MOUSE_MODE_CAPTURED
	elif event.is_action_pressed("disable_mouse_capture") and Input.mouse_mode == Input.MOUSE_MODE_CAPTURED:
